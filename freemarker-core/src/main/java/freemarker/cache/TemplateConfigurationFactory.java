...
public abstract class TemplateConfigurationFactory {
     ...
     *
     * @return The {@link TemplateConfiguration} to apply, or {@code null} if the there's no
     * {@link TemplateConfiguration} for this template source.
     *
     * @throws IOException
     *         Typically, if the factory needs further I/O to find out more about the template source, but that fails.
     ...
     * another {@link Configuration} anymore. This is automatically called by
     ...
     * {@link TemplateConfiguration} and {@link TemplateConfigurationFactory#setConfiguration(Configuration)} on each
     * enclosed {@link TemplateConfigurationFactory} objects. It only supposed to call these on the direct "children" of
     * this object, not on the children of the children.
     */
