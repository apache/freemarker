...
public interface TemplateLoader {
     ...
     *         implementation. As this object is possibly used as a cache key, {@link Object#equals(Object)} and
     *         {@link Object#hashCode()} must be properly implemented. Especially, template sources that refer to the
     *         same physical source must be equivalent (otherwise template caching can become inefficient). (Of course,
     *         this only applies when the compared template sources were generated by the same {@link TemplateLoader}.)
     * 
     * @throws IOException
