...
/**
 */
class JakartaFreeMarkerJspApplicationContext implements JspApplicationContext {
    ...
    ELContext createNewELContext(final JakartaFreeMarkerPageContext pageCtx) {
    ...
    private class FreeMarkerELContext extends ELContext {
        private final JakartaFreeMarkerPageContext pageCtx;
        
        FreeMarkerELContext(JakartaFreeMarkerPageContext pageCtx) {
            ...
            return new VariableMapper() {
                ...
                public ValueExpression setVariable(String name, 
                    ...
                    pageCtx.setAttribute(name, value.getValue(
                            JakartaFreeMarkerJspApplicationContext.FreeMarkerELContext.this));
                    return prev;
                }
            };
        }
