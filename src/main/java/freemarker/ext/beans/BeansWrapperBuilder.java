 ...
 * <pre>
 *    BeansWrapper beansWrapper = new BeansWrapperBuilder(new Version(2, 3, 21)).getObject();
 * </pre>
 * 
 ...
 *    
 *    // Get the singleton:
 *    BeansWrapper beansWrapper = builder.getObject();
