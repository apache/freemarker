 ...
 * spring.ftl
 *
 * This library consists of a collection of common useful FreeMarker macros
...
<#macro bind path>
    ...
    <#if status.value?exists && status.value?isBoolean>
...
<#macro showErrors separator classOrStyle="">
    ...
    <#if classOrStyle == "">
        <b>${error}</b>
    <#else>
        <#if classOrStyle?indexOf(":") == -1><#assign attr="class"><#else><#assign attr="style"></#if>
...
<#macro checkSelected value>
    <#if stringStatusValue?isNumber && stringStatusValue == value?number>selected="selected"</#if>
    <#if stringStatusValue?isString && stringStatusValue == value>selected="selected"</#if>
</#macro>
